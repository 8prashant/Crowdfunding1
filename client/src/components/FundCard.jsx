...
import { tagType, thirdweb,pi1 } from '../assets';
    ...
    <div className="sm:w-[288px] w-full rounded-[15px] bg-[#1c1c24] cursor-pointer" onClick={handleClick}>
      ...
      <div className="flex flex-col p-4">
        ...
        <div className="flex items-center mt-[20px] gap-[12px]">
          <div className="w-[36px] h-[36px] rounded-full overflow-hidden bg-[#2c2f32] flex justify-center items-center cursor-pointer">
            <img src={pi1} alt="user" className="w-full h-full object-cover" />
          </div>
